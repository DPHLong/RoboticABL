...
from speed_controller import sc_init, set_desired_speed, sc_shutdown
...
def main(args):
	...
	sc_init() #init speed controller
	print("Node started")
	total_timer.start()

	odom_sub = rospy.Subscriber("/localization/odom/5", Odometry, odom_cb, queue_size=10)
	rospy.sleep(1)
